...
/// <summary>
/// Validador para la actualización de categorías de eventos
/// </summary>
public class UpdateEventCategoryDtoValidator : AbstractValidator<UpdateEventCategoryDto>
{
    public UpdateEventCategoryDtoValidator()
    {
        RuleFor(x => x.Name)
            .NotEmpty()
