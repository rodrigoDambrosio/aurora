import { Calendar, Heart, LogOut, MessageCircle, Moon, Settings, Smile, Sparkles, Sun, TrendingUp } from 'lucide-react';
import React, { useState } from 'react';
import { useTheme } from '../context/ThemeContext';
import { apiService } from '../services/apiService';
import './Navigation.css';

type View = 'calendar-week' | 'calendar-month' | 'mood-month' | 'wellness' | 'assistant' | 'productivity' | 'settings';
